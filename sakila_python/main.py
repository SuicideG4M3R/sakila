...
#     INSERT INTO {table_name}(name, email, password) VALUES (%s, %s, %s)
# """).format(table_name=sql.Identifier('User'))
#
#
#
...
#
# try:
#     cursor.execute(query_insert_user_tb, ('Ala', 'abc@gmail.com', 'jjjsssjjj'))
# except DatabaseError as error:
#     print(error)
#
# try:
#     cursor.execute(query_update_user_tb, ('TopSecret',))
# except DatabaseError as error:
#     print(error)
#
# try:
